...
public interface IServiceRepository
{
    ...
    Task<(IEnumerable<Service> Services, int TotalCount)> GetAllByClinicIdAsync(Guid clinicId, int pageNumber, int pageSize, CancellationToken cancellationToken = default);
